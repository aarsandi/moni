...
export default function CompFormPayLoan({data, onSubmit, navigation}) {
    ...
    useEffect(() => {
        if(type==="Tabungan"&&amountDompet&&amountTabungan&&formData.amountTabunganAft&&formData.amountDompetAft&&amountPay[0]) {
    ...
    return (
        <View style={{paddingHorizontal:18, paddingTop: 18}}>
            ...
            <TextInput editable={false} style={styles.formInput} value={amountPay[0]?toRupiah(amountPay[0].amount, "Rp. "):"0"} placeholder="Rp. 0" placeholderTextColor="#838383"/>
            {
                data.type==="Tabungan"&&
